                ...
                <div className="p-4">
                    ...
                    <nav>
                        <ul className="space-y-2">
                            <li><a href="#" className="flex items-center text-gray-600 hover:text-blue-500"><i className="far fa-file-alt mr-3"></i>General</a></li>
                            <li><a href="#" className="flex items-center text-gray-600 hover:text-blue-500"><i className="far fa-calendar-check mr-3"></i>Citas</a></li>
                            <li><a href="#" className="flex items-center text-blue-500"><i className="fas fa-user-injured mr-3"></i>Pacientes</a></li>
                            <li><a href="#" className="flex items-center text-gray-600 hover:text-blue-500"><i className="far fa-clock mr-3"></i>Horarios</a></li>
                            <li><a href="#" className="flex items-center text-gray-600 hover:text-blue-500"><i className="fas fa-pills mr-3"></i>Medicacion</a></li>
                            <li><a href="#" className="flex items-center text-gray-600 hover:text-blue-500"><i className="far fa-envelope mr-3"></i>Mensajes</a></li>
                        </ul>
                    </nav>
                </div>
                ...
                <div className="p-8">
                    <div className="bg-white shadow-md rounded-lg p-6 mb-6">
                        ...
                        <div className="flex">
                            <div className="w-1/3 pr-4 relative">
                                ...
                                <button className="absolute top-2 right-2 text-gray-500"><i className="fas fa-times"></i></button>
                            </div>
                            <div className="w-2/3">
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6 mb-6">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <button className="text-gray-500"><i className="fas fa-expand-alt"></i></button>
                        </div>
                    </div>
                    <div className="bg-white shadow-md rounded-lg p-6 mb-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center bg-gray-100 p-2 rounded">
                                ...
                                <div>
                                    ...
                                    <button className="text-gray-500"><i className="fas fa-chevron-down"></i></button>
                                </div>
                            </div>
                            <div className="flex justify-between items-center bg-gray-100 p-2 rounded">
                                <span>2.Fiebre</span>
